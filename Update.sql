...
-- Dumping data for table pos_bang_rulz.produk: ~6 rows (approximately)
INSERT INTO `produk` (`id`, `Kategori_id`, `user_id`, `foto`, `nama`, `harga_beli`, `harga_jual`, `stok`, `created_at`, `updated_at`) VALUES
	(1, NULL, 1, 'products/Fi1YOnDlySZ36gPJXIc5DJVbZBT5LJQL8hJJzpU6.jpg', 'Blok seher Uma Racing', 3900000, 4500000, 98, '2026-08-10 19:16:06', '2026-09-06 21:12:27'),
	(3, NULL, 1, 'products/8U297dfIzYZ88gUeUwX7BEVPIZRKVu6L3VGITdJ2.jpg', 'Aracer super x', 8500000, 9000000, 49, '2026-08-10 19:21:23', '2026-09-06 21:17:36'),
	(6, NULL, 1, 'products/n9lxiyOhkylr2aKQiffpRHR8xHV99Df1Kxxt913z.jpg', 'VND Premium', 1600000, 2000000, 60, '2026-08-10 20:20:36', '2026-09-06 22:22:22'),
	(8, NULL, 1, 'products/mJINYKmN7o9aLI12gLPYCqvbfICJ7pGKJgXFuORF.jpg', 'Oli Shell', 55000, 95000, 90, '2026-08-10 20:22:43', '2026-09-06 23:00:36'),
	(10, NULL, 1, 'products/N5fyib9umnjyxaNiySc4aN3PuIbJx4eQjFtU0tXv.jpg', 'Sensor TPS Uma Racing', 450000, 500000, 100, '2026-08-11 00:01:13', '2026-09-06 23:01:49'),
	(12, NULL, 1, 'products/wjG5MwtJHM3GLh1doTSsrOENs7LuMxVV9cOd0BYy.jpg', 'gas spontan daytona', 100000, 130000, 89, '2026-08-11 00:56:17', '2026-09-06 23:02:31');
...
-- Dumping data for table pos_bang_rulz.sessions: ~0 rows (approximately)
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('T18j9vgO0ygt5IAlWcQcjglnhydsNVK81DlsnOpb', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36', '', 1788760951);
